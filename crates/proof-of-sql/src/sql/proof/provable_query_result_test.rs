...
fn we_can_evaluate_result_columns_as_mles() {
    ...
    let expected_evals = [TestScalar::from(10u64) * evaluation_vec[0]
        - TestScalar::from(12u64) * evaluation_vec[1]];
...
fn we_can_evaluate_multiple_result_columns_as_mles() {
    ...
    let evals = res
        ...
        .unwrap();
    let expected_evals = [
        TestScalar::from(10u64) * evaluation_vec[0]
            + TestScalar::from(12u64) * evaluation_vec[1],
        TestScalar::from(5u64) * evaluation_vec[0]
            + TestScalar::from(9u64) * evaluation_vec[1],
    ];
    assert_eq!(evals, expected_evals);
}
